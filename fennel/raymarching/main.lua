...
local function sphere_distance(_1_, _4_)
  local _arg_2_ = _1_
...
local function sphere(radius, pos, color)
  ...
  local g = _let_7_[2]
  local b = _let_7_[3]
  return {color = {(r or 0), (g or 0), (b or 0)}, pos = {(x or 0), (y or 0), (z or 0)}, radius = (radius or 5), sdf = sphere_distance}
end
love.draw = function()
  love.graphics.print(sphere_distance(sphere(5), {5, 0, 0}), 0, 0)
  love.graphics.print(sphere_distance(sphere(5), {0, 15, 0}), 0, 15)
  love.graphics.print(sphere_distance(sphere(5), {0, 0, 0}), 0, 30)
